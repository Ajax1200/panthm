  ...
  const BlogCard = ({ blog }) => (
    ...
    >
      <div className="relative overflow-hidden aspect-video">
        ...
        {blog.categoryId && (
          <div className="absolute top-4 left-4 bg-white/90 dark:bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-semibold text-primary dark:text-primary uppercase tracking-wider">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3 line-clamp-2 group-hover:text-primary dark:group-hover:text-primary transition-colors">
          {blog.title}
        </h3>
              ...
              displayBlogs.length > 0 && (
                <div className="flex items-center justify-center gap-4 mt-12">
                  <button
                    ...
                    className="w-12 h-12 rounded-full border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-600 dark:text-slate-400 hover:bg-primary hover:text-white dark:hover:bg-primary dark:hover:border-primary transition-all"
